...
<body>
	<div align="center">
		<h2>Account Deletion Unsuccessful</h2>
        ...
        <h3>Your account was not successfully deleted. </h3>
        <h3>Please make sure your deposits and crypto balances are empty prior to your account deletion.</h3>
